...
#list object - my_list = [*transformation/expression,*iteration,*condition]
...
# a lot more concise and easier to write
...
# iterator is i so that is why we are using it, can be anything
...
upper = [x.upper() for x in lower] #orrr ["a","b","c"]]]
print(upper)
